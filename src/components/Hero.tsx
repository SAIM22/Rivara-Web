    ...
    <section id="home" className="pt-24 md:pt-20 pb-16 md:pb-32 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="relative">
          ...
          <div className="relative">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent leading-tight pt-1 pb-3">
              Transforming Industries Through AI
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 md:mb-8 max-w-3xl">
