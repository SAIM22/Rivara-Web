...
export default function WhyWeAreHere() {
  const sections = [
    ...
    },
    {
      ...
      description: "Our AI solutions don't just automate; they elevate. We help organisations become more efficient, resilient, and future-ready, equipping you with tools to achieve real, measurable progress."
    }
  ];

  return (
    <section id="why-we-are-here" className="py-12 md:py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {sections.map((section, index) => (
            <div key={index} className="bg-slate-700/30 p-4 md:p-6 rounded-xl backdrop-blur-sm hover:transform hover:-translate-y-2 transition-all duration-300">
              <div className="text-blue-500 mb-4">{section.icon}</div>
              <h3 className="text-lg md:text-xl font-semibold mb-3">{section.title}</h3>
